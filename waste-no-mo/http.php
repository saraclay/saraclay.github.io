...
<title>http.php - PHP HTTP protocol client - PHP Classes</title>
...
<link rel="canonical" href="http://www.phpclasses.org/browse/file/5.html">
<meta name="description" lang="en" content="HTTP class file. http.php Class that implements requests to Web resources using the HTTP protocol. It features: - May submit HTTP requests with any method, to any page, to any server, connecting to any port. - Provides support to setup connection and request arguments from a given URL. - May submit requests via a proxy server with support for authentication if necessary. - May establish...">
...
<td  style=" white-space: nowrap ;"><a href="/login.html?page=browse%2Ffile%2F5.html">Login</a></td>
<td  style=" white-space: nowrap ; padding: 1px">&nbsp;</td>
<td  style=" white-space: nowrap ;"><a href="/register.html?page=browse%2Ffile%2F5.html">Register</a></td>
<td width="49.5%"  style=" white-space: nowrap ; padding: 1px">&nbsp;</td>
</tr>
<tr>
...
<tr>
<td class="tabcontent box light"><a href="http://www.phpclasses.org/recommend_page.html?title=http.php&amp;page=%2Fbrowse%2Ffile%2F5.html">Recommend</a> this page to a friend!</td>
<td class="box light"><div class="g-plusone" data-size="medium" data-href="http://www.phpclasses.org/browse/file/5.html"></div><script type="text/javascript"><!--
  (function() {
...
<td class="nbtu light"><a href="/package/3-PHP-HTTP-client-to-access-Web-site-pages.html">PHP HTTP protocol client</a></td>
<td class="nbgu">&nbsp;<b>&gt;</b>&nbsp;</td>
<td class="nblu"><b>http.php</b></td>
<td width="49.5%" class="nbgu">&nbsp;</td>
</tr>
<tr>
...
<TD>HTTP class file</TD>
</TR>
<TR class="even">
<TH VALIGN="top" ALIGN=right WIDTH="1%" NOWRAP><!--htdig_noindex-->Class<!--/htdig_noindex-->:</TH>
<TD><a href="/package/3-PHP-HTTP-client-to-access-Web-site-pages.html">PHP HTTP protocol client</a><br>
<B>HTTP client to access Web site pages</B></TD>
</TR>
<TR class="odd">
...
<TD>Assumed that when response status is 204, content length is 0 when no<br>
content-length header is set.</TD>
</TR>
<TR class="odd">
<TH VALIGN="top" ALIGN=right WIDTH="1%" NOWRAP><!--htdig_noindex-->Date<!--/htdig_noindex-->:</TH>
<TD><span title="2014-08-14 16:18:47">2 months ago</span></TD>
</TR>
<TR class="even">
<TH VALIGN="top" ALIGN=right WIDTH="1%" NOWRAP><!--htdig_noindex-->Size<!--/htdig_noindex-->:</TH>
<TD><TT>69,422 bytes</TT></TD>
</TR>
<tr style="height: 99%">
<td colspan="2"></TD>
</TR>
...
<!-- google_ad_section_end --></div>
        <div id="ads"></div>
        <div class="InfoContent"><!-- body_start --><h2 align="center">You need to be a <a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'register', '', '/register.html?page=', 'browse\x2ffile\x2f5.html');" href="/register.html?page=browse%2Ffile%2F5.html">registered</a> user and <a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', '', '/login.html?page=', 'browse\x2ffile\x2f5.html');" href="/login.html?page=browse%2Ffile%2F5.html">login</a> to get this file.</h2>
...
<script type="text/javascript"><!--
 ...
 ga('send', 'event', 'Login-Prompt-View-File-Be-one-of-us', 'prompt', 'browse\x2ffile\x2f5.html');
// --></script>
<h2 align="center">Login Immediately with your account on:</h2><table align="center"><tr><td align="right"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'Facebook', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html"><img src="http://files.phpclasses.org/graphics/identity/Facebook.png" width="24" height="24" alt="Facebook Connect" align="middle" border="0"></a></td><td><div style="background-color: #3b5b99; border-radius: 8px; padding: 6px; text-align: center"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'Facebook', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html" style="color: #ffffff; font-weight: bold; text-decoration: none">Facebook Connect</a></div></td><td align="right"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'Google', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html"><img src="http://files.phpclasses.org/graphics/identity/Google.png" width="24" height="24" alt="Gmail or other Google Account" align="middle" border="0"></a></td><td><div style="background-color: #ffd200; border-radius: 8px; padding: 6px; text-align: center"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'Google', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html" style="color: #000000; font-weight: bold; text-decoration: none">Gmail or other Google Account</a></div></td><td align="right"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'Microsoft', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html"><img src="http://files.phpclasses.org/graphics/identity/Microsoft.png" width="24" height="24" alt="Hotmail or Microsoft Windows Live" align="middle" border="0"></a></td><td><div style="background-color: #b6cf72; border-radius: 8px; padding: 6px; text-align: center"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'Microsoft', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html" style="color: #000000; font-weight: bold; text-decoration: none">Hotmail or Microsoft Windows Live</a></div></td><td align="right"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'StackExchange', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html"><img src="http://files.phpclasses.org/graphics/identity/StackExchange.png" width="24" height="24" alt="StackOverflow" align="middle" border="0"></a></td><td><div style="background-color: #eeeeee; border-radius: 8px; padding: 6px; text-align: center"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'StackExchange', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html" style="color: #000000; font-weight: bold; text-decoration: none">StackOverflow</a></div></td><td align="right"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'github', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html"><img src="http://files.phpclasses.org/graphics/identity/github.png" width="24" height="24" alt="GitHub" align="middle" border="0"></a></td><td><div style="background-color: #a6f5ff; border-radius: 8px; padding: 6px; text-align: center"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'github', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html" style="color: #000000; font-weight: bold; text-decoration: none">GitHub</a></div></td><td align="right"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'Yahoo', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html"><img src="http://files.phpclasses.org/graphics/identity/Yahoo.png" width="24" height="24" alt="Yahoo" align="middle" border="0"></a></td><td><div style="background-color: #dce2e7; border-radius: 8px; padding: 6px; text-align: center"><a onclick="trackOutboundLink('Login-Prompt-View-File-Be-one-of-us', 'login', 'Yahoo', '/login.html?page=', 'browse\x2ffile\x2f5.html'); return false;" href="/login.html?page=browse%2Ffile%2F5.html" style="color: #660066; font-weight: bold; text-decoration: none">Yahoo</a></div></td></tr></table><iframe style="width: 100%; height: 900px; border-width: 0px" src="/requirement.html"></iframe><!-- body_end --><script type="text/javascript"><!--
cl.addContent({
